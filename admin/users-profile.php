...
if (!isset($_SESSION['id'])) {
  ...
  try {
    ...
    $stmt = $pdo->prepare("
            SELECT 
                uc.email, uc.role, phone_number, admin_id, last_login, about_me, sitio, 
    ...
    if ($user) {
      ...
      $formattedName = $fname . ' ' . $initial . ' ' . $lname;
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <h2 style="text-align: center;"><?php echo $formattedName; ?></h2>
              <h3><?php echo $role ?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo "A" . str_pad($admin_id, 4, "0", STR_PAD_LEFT); ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="../check.php" method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="admin_id" type="hidden" class="form-control" id="admin_id" value="<?php echo $id ?>" readonly>
                      </div>
                    </div>
