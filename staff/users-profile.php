...
if (!isset($_SESSION['id'])) {
    ...
    try {
        // Fetch user details with a JOIN fo
        $stmt = $pdo->prepare("
            SELECT                 
                uc.email, uc.role, phone_number, staff_id, about_me, sitio, 
                ...
                date_of_birth, hire_date, status
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo "S" . str_pad($id, 4, "0", STR_PAD_LEFT); ?></div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-9 col-md-8"><?php echo $hire_date ?></div>
                                    </div>
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    ...
                                    <form action="../check.php" method="POST">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="staff_id" type="hidden" class="form-control" id="staff_id" value="<?php echo $id ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label for="rd" class="col-md-4 col-lg-3 col-form-label">Hire Date</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="hire_date" type="date" class="form-control" id="rd" value="<?= $hire_date; ?>" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-primary" name="saveStaff">Save Changes</button>
                                        </div>
